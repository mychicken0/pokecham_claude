...
def _type_claim_guard(answer_text: str, receipt: dict):
    ...
    if claims and not type_receipts:
        failures.append({
            ...
            "detail": "Public type effectiveness claims require verify.py typechart, type-matrix, or damage typechart receipt. Do not infer immune/resist/weak/neutral from memory.",
